  ...
  <div className="bg-white rounded-lg shadow-md overflow-hidden">
    <div className="flex lg:flex-row w-full">
      ...
      <div className="p-4 text-right w-1/2">
        <h2 className="lg:text-lg text-sm max-lg:line-clamp-2 font-bold text-blue-800 mb-2 lg:leading-8 leading-6">
          {title}
        </h2>
        <p className="text-gray-600 text-sm lg:leading-7 leading-6 max-lg:line-clamp-3">
          {description}
        </p>
      </div>
    </div>
...
const FeaturedNews = ({ title, description, imageSrc, imageAlt }) => (
  <div className="bg-white rounded-lg shadow-md overflow-hidden">
    <div className="flex flex-col">
      ...
      <div className="p-4 text-right">
        <h2 className="text-xl font-bold text-blue-800 mb-3 leading-8">{title}</h2>
...
export default function LastNewsComponent({ data }) {
  ...
  return (
    <div className="lg:px-20 px-4 flex flex-col gap-6 justify-center items-center lg:justify-start lg:items-start text-right w-full">
      <NewsHeader
        title={header.title}
        ...
        <>
          <div className="rounded-lg overflow-hidden shadow-md flex flex-col">
            ...
            <div className="p-4 bg-white flex-1 min-h-[177px] flex flex-col">
              ...
              <p className="text-gray-700 text-right text-sm leading-8">
                ...
                دانشگاه جامع انقلاب اسلامی نشست عمومی جناب آقای دکتر قاضی زاده هاشمی از دانشگاه جامع
                انقلاب اسلامی
              </p>
            </div>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 w-full">
            {regularNews.map(item => {
              return (
                <div className="rounded-lg overflow-hidden shadow-md flex flex-col lg:flex-row">
