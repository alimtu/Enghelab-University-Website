...
export default function WhyCuIrComponent({ whyCuIrData }) {
  return (
    <div className="px-4 lg:px-8 py-8 flex flex-col lg:gap-8 gap-6">
      <div className="flex flex-col lg:gap-4 gap-2">
        <h1 className="text-2xl lg:text-3xl font-bold text-gray-900 ">{whyCuIrData.title}</h1>
        <p className="text-gray-600 text-base leading-7 lg:text-xl">{whyCuIrData.description}</p>
      </div>
      <div className="flex flex-col lg:flex-row gap-6 items-center lg:h-[584px]">
        ...
        <div className="w-full lg:w-7/12 relative rounded-md overflow-hidden h-full aspect-video lg:aspect-auto cursor-pointer">
          <Image
            src={whyCuIrData.videoImagePath}
