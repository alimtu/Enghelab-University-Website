    ...
    <div className="w-full h-screen flex flex-col justify-center items-center m-auto">
      <div>
        ...
        <div className="flex flex-col justify-center items-center m-auto">
          ...
          <Link
            className=" w-48 lg:w-64 h-16 bg-secondary-500 transition-all hover:bg-secondary-600 hover:scale-105 ease-in text-white px-6 lg:text-xl text-center rounded-lg flex items-center justify-center"
            href="/"
          >
            بازگشت به صفحه اصلی
          </Link>
