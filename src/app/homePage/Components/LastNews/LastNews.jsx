...
function LastNews({ newstitle = [] } ,isOk) {
        ...
        return <>
            <div className="flex flex-col">
                ...
                <div className="header w-full px-16 flex flex-col lg:flex-row justify-between">
                    <div>
                        <p className="text-3xl text-center lg:text-right font-black mt-8"> آخرین اخبار معاونت</p>
                ...
                {Array.isArray(newstitle) &&
                    newstitle.map((item, index) => (
                        <div className="w-full px-4 lg:px-16  mt-6 grid grid-cols-1 gap-6" key={index}>
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className="p-2 flex flex-col justify-around">
                                                ...
                                                <p className="text-sm line-clamp-1 lg:line-clamp-2 text-base/6 lg:text-base/7 overflow-hidden">{desc}</p>
                                            </div>
                                        </div>
                                    );
                                })}
    ...
    return (
        <div className="flex flex-col">
            ...
            <div className="header w-full px-16 flex flex-col lg:flex-row justify-between">
                <div>
                    <p className="text-3xl text-center lg:text-right font-black mt-8"> آخرین اخباردانشگاه</p>
                    <p className="text-sm text-center lg:text-right mt-3 text-gray-500 ">
                        برای اطلاع از آخرین اخبار به پورتال خبری دانشگاه مراجعه کنید.
                    </p>
                </div>
            ...
            {Array.isArray(newstitle) &&
                newstitle.map((item, index) => (
                    <div className="w-full px-4 lg:px-16  mt-6 grid grid-cols-1 lg:grid-cols-2 gap-6" key={index}>
