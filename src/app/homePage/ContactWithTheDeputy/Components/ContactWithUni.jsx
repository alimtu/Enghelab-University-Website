...
const ContactWithDeputiesData = {
    ...
    items: [
        ...
        { title: 'معاونت فرهنگی و اجتماعی', desc: '۰۲۱-۰۰۰۰-۰۰۰۰', icon: <Phone /> },
        { title: 'معاونت آموزشی و تحصیلات تکمیلی', desc: '۰۲۱-۰۰۰۰-۰۰۰۰', icon: <Phone /> },
...
const ContactWithFacultiesData = {
    ...
    items: [
        { title: 'دانشکده مقاومت مردمی انقلاب اسلامی', desc: '۰۲۱-۰۰۰۰-۰۰۰۰', icon: <Phone /> },
        { title: 'دانشکده فرهنگ و هنر انقلاب اسلامی', desc: '۰۲۱-۰۰۰۰-۰۰۰۰', icon: <Phone /> },
        { title: 'دانشکده علوم انسانی و اسلامی انقلاب اسلامی', desc: '۰۲۱-۰۰۰۰-۰۰۰۰', icon: <Phone /> },
        { title: 'دانشکده سبک زندگی اسلامی ایرانی انقلاب اسلامی', desc: '۰۲۱-۰۰۰۰-۰۰۰۰', icon: <Phone /> },
        { title: 'دانشکده فناوری‌های نوین انقلاب اسلامی', desc: '۰۲۱-۰۰۰۰-۰۰۰۰', icon: <Phone /> },
        { title: 'دانشکده علوم بنیادی انقلاب اسلامی', desc: '۰۲۱-۰۰۰۰-۰۰۰۰', icon: <Phone /> },
        { title: 'دانشکده بهداشت و سلامت انقلاب اسلامی', desc: '۰۲۱-۰۰۰۰-۰۰۰۰', icon: <Phone /> },
    ],
};
...
const ContactWithSubdivisionsData = {
    ...
    items: [
        ...
        { title: 'آموزش‌های آزاد و الکترونیکی', desc: '۰۲۱-۰۰۰۰-۰۰۰۰', icon: <Phone /> },
        { title: 'مركز رشد پارک علم و فناورى', desc: '۰۲۱-۰۰۰۰-۰۰۰۰', icon: <Phone /> },
        { title: 'دفتر کار و ارتباطات دانشجویی', desc: '۰۲۱-۰۰۰۰-۰۰۰۰', icon: <Phone /> },
        { title: 'مرکز خدمات آزمایشگاهی', desc: '۰۲۱-۰۰۰۰-۰۰۰۰', icon: <Phone /> },
        { title: 'امور ورزشی و تربیت بدنی', desc: '۰۲۱-۰۰۰۰-۰۰۰۰', icon: <Phone /> },
    ],
};
...
const ContactWithPublicRelationsData = {
    title: 'روابط عمومی',
    items: [
        { title: 'مرکز روابط عمومی', desc: '۰۲۱-۰۰۰۰-۰۰۰۰', icon: <Phone /> },
