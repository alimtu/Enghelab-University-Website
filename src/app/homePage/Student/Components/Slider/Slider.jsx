...
export default function Slider({ title = "" }) {
    ...
    return (
        <div className="w-full h-full max-h-5/12 bg-white relative flex justify-center items-center mt-18 md:mt-0">
            <Swiper
                slidesPerView={1}
                loop={true}
                pagination={{
            ...
            {title && (
                <div className="absolute bottom-18 text-white z-20 font-bold text-xl lg:text-2xl">
                    {title}
                </div>
            )}
        </div>
