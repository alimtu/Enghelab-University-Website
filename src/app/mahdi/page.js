...
const dummyNews = [
  {
    ...
    newstitle1:
      'رونمایی کتاب «کتاب شناسی اختصاصی غزّه» به اهتمام دکتر سیّدحجّت الحق حسینی استاد دانشگاه صنعتی خواجه نصیرالدّین طوسی',
    desc1:
      'به گزارش روابط عمومی دانشگاه جامع انقلاب اسلامی، رونمایی کتاب «کتاب شناسی اختصاصی غزّه» به اهتمام دکتر سیّدحجّت الحق حسینی استاد دانشگاه صنعتی خواجه نصیرالدّین طوسی در تالار همایش های کوثر برگزار گردید.',
    pic2: '/Images/interview.png',
    newstitle2: 'دانشجویان دانشگاه تراز انقلاب باید پژوهشگر باشند.',
    desc2:
      'دانشجویان دانشگاه تراز انقلاب باید پژوهشگر باشند. دکتر قدیانی رئیس دانشگاه جامع انقلاب اسلامی در شورای پژوهشی دانشگاه مطرح کرد:...',
    ...
    content: (
      <div className="space-y-2 rtl">
        ...
        <p className="text-sm text-gray-700">
          بررسی مسائل مختلف پژوهشی و کشف استعدادهای پژوهشی و گسترش آن در میان
          دانشجویان پژوهشی، انتشار مجلات پژوهشی، حمایت پژوهشی و غیره. هدف اصلی
          گروه پژوهشی، حمایت پژوهشی محتوای پژوهشی است.
        </p>
        <ol className="list-decimal list-inside space-y-1 pr-4">
          ...
          <li>
            کمک به حل مشکلات علمی، فرهنگی، اجتماعی و اقتصادی از طریق تحقیق و
            پژوهش
          </li>
    ...
    content: (
      <div className={'flex flex-col gap-6'}>
        <div className={'flex justify-between px-20 items-center'}>
          <p className={'text-lg font-medium'}>مقررات نگارش پایان نامه</p>
