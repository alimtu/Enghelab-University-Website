    ...
    return (
        <div className="flex flex-col">
            <div className="header m-2 flex flex-col lg:flex-row justify-between">
                <div>
                    <p className="text-[28px] text-center lg:text-right font-bold mt-4">{t('title')}</p>
                    <p className="text-[15px] text-center lg:text-right">{t('description')}</p>
                </div>
                <button
                    type="submit"
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 w-[95%] m-auto rounded-[12px] gap-4 mt-4">
                        ...
                        <div className="grid grid-cols-2 shadow-2xl shadow-gray-300 rounded-[12px]">
                            ...
                            <div className="mr-2 flex flex-col justify-center">
                                <p className="text-[13px] lg:text-[20px] text-[#005B90]">{t('newstitle2')}</p>
                        ...
                        <div className="grid grid-cols-2 shadow-2xl shadow-gray-300 rounded-[12px]">
                            ...
                            <div className="mr-2 flex flex-col justify-center">
                                <p className="text-[13px] lg:text-[20px] text-[#005B90]">{t('newstitle3')}</p>
